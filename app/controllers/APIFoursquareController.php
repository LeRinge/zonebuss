...
class APIFoursquareController extends \BaseController {
	...
	public function places(){
		...
		$URL=$URL_FOURSQUARE_API . (string)$data['lat'] . ',' . (string)$data['lng'] . '&radius=450' . '&query='. 'food' .'&client_id=' . $CLIENT_ID_API_FOURSQUARE . '&client_secret=' . $CLIENT_SECRECT_FOURSQUARE . '&v=20141114';
